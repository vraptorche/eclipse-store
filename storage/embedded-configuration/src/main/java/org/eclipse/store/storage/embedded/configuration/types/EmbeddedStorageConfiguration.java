...
public final class EmbeddedStorageConfiguration {
     ...
     * @see #DefaultResourceName()
     */
    public static EmbeddedStorageConfigurationBuilder load(final Charset charset) {
        return load(coalesce(System.getProperty(PathProperty()), DefaultResourceName()), charset);
    }
     ...
     * @see #DefaultResourceName()
     */
    public static EmbeddedStorageConfigurationBuilder load(final String path,
